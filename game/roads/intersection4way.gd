...
var point_four = Vector3(-10,0,0)

var open_exits = [point_one, point_two, point_three, point_four]
var used_exits = {}
...
func _ready():
	...
	point_four_left = Vector3(point_four.x, point_four.y, point_four.z + road_width)
	point_four_right = Vector3(point_four.x, point_four.y, point_four.z - road_width)
	...
	array.push_back(middle_bottom_right) #15
	
	# fourth part
	array.push_back(point_four_left) #16
	array.push_back(point_four) #17
	array.push_back(point_four_right) #18
	array.push_back(array[5]-Vector3(0,0,+road_width)) #19
...
func meshCreate(material, array):
	...
	# fourth exit
	addQuad(array[16], array[17], array[19], array[5], material, surface, false)
	addQuad(array[17], array[18], array[15], array[19], material, surface, true)
